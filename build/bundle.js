...
var $toString = __webpack_require__(454);
...
// 19.1.2.2 / 15.2.3.5 Object.create(O [, Properties])
var anObject = __webpack_require__(36);
var dPs = __webpack_require__(245);
...
var isObject = __webpack_require__(4);
var setPrototypeOf = __webpack_require__(127).set;
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(24)(Function.call, __webpack_require__(17).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var core = __webpack_require__(25);
var LIBRARY = __webpack_require__(40);
var wksExt = __webpack_require__(189);
...
var has = __webpack_require__(41);
var toIObject = __webpack_require__(55);
var arrayIndexOf = __webpack_require__(244)(false);
var IE_PROTO = __webpack_require__(98)('IE_PROTO');
...
module.exports = !__webpack_require__(26) && !__webpack_require__(53)(function () {
...
var _defineProperty = __webpack_require__(194);
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(54)(Function.call, __webpack_require__(133).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
        buggy = !(test instanceof Array);
      } catch (e) { buggy = true; }
      return function setPrototypeOf(O, proto) {
...
var _regenerator = __webpack_require__(254);
...
// ^^ Exports and Imports not working through Babel^^
{
  ...
  */
  ...
  var limit = 100;
  //limit+=100;
  var message = " Event limited to " + limit + " people";
  console.log(message);
  var a = [20, 30, 40, 50];
  var b = [10].concat(a, [60]); // using ... spread operator
  console.log(b);

  collect(1, 2, 3, 4, 5);

  var animals = ["Simba", "Zazu", "Ed"];
  var lion = animals[0],
      bird = animals[1]; // destructuring

  console.log(lion, bird);

  var king = { name: 'Mufasa', kids: 1 };
  {
    var _name = king.name;
    var _kids = king.kids;
    var _msg = "Without destructuring " + _name + " " + _kids;
    console.log(_msg);
  }
  ...
  var msg = "With destructuring " + name + " " + kids;
  console.log(msg);
}
...

{
  ...
  */
  ...
  // Map and Filter
  {
    var _values = [20, 30, 40];
    var _double = function _double(n) {
      return n * 2;
    };
    var doubles = _values.map(function (n) {
      return n * 2;
    });
    //console.log(doubles);
  }
  ...
  // Map and Filter
  {
    var _values2 = [20, 30, 40];
    var _double2 = function _double2(n) {
      return n * 2;
    };
    var _doubles = _values2.map(function (n) {
      return n * 2;
    });
    console.log(_doubles);
  }
  {
    var _points = [7, 6, 21, 22, 4, 3, 5];

    var _highScores = _points.filter(function (n) {
      return n > 15;
    });
    //console.log(highScores);
  }

  var points = [7, 6, 21, 22, 4, 3, 5];
...

{
  ...
  // prototypes in es6
  var wizard = function wizard(name, house, pet) {
    var _this2 = this;
    ...
    this.greet = function () {
      return "I'm " + _this2.name + " from " + _this2.house;
    };
  };
  ...
  */
  ...
  var _king = new Animal('Mufasa', 4.5);
  //console.log(king);
  _king.hello();

  var Lion = function (_Animal) {
    (0, _inherits3.default)(Lion, _Animal);

    function Lion(name, height, color) {
      (0, _classCallCheck3.default)(this, Lion);

      var _this = (0, _possibleConstructorReturn3.default)(this, (Lion.__proto__ || (0, _getPrototypeOf2.default)(Lion)).call(this, name, height));

      _this.color = color;
      return _this;
    }

    (0, _createClass3.default)(Lion, [{
      key: "hello",
      value: function hello() {
  ...
  var son = new Lion("Simba", 2, 'Golden');
  //console.log(son);
  son.hello();
  ...
  var Calculator = function () {
    ...
    (0, _createClass3.default)(Calculator, null, [{
      key: "multiply",
  ...
  var res = Calculator.multiply(2, 5);
  ...
  var Harry = new wizard("Harry Potter", "Gryffindor", "Owl");
...

{
  ...
  */
  //Sets in ES6
  var _a = new _set2.default();
  _a.add(5);
  _a.add(43);
  _a.add("Woohoo");
  _a.add({ x: 50, y: 200 });
  console.log(_a);
  console.log(_a.has(5));

  var numbers = [1, 2, 3, 4, 5, 5, 4];
  var numSet = new _set2.default(numbers);
  console.log(numSet);
  ...
  try {
    for (var _iterator = (0, _getIterator3.default)(numSet.values()), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
  ...
  var chars = 'randomizedStringOfAlphabets';
  var charsArr = chars.split("");
  var charsSet = new _set2.default(charsArr);

  console.log(charsSet);

  // Maps in es6

  var sampleMap = new _map2.default();
  var key_1 = "String key";
  var key_2 = { a: 'key' };
  var key_3 = function key_3() {};
  ...
  var numArr = [[1, 'one'], [2, 'two'], [3, 'three']];
  var valMap = new _map2.default(numArr);
  ...
  try {
    for (var _iterator2 = (0, _getIterator3.default)(valMap.entries()), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
  ...
  var string = 'dgdfhgfdgfsfdsghjhg';
  var letters = new _map2.default();
...

{
  ...
  */
  ...
  var addSuffix = function addSuffix(x) {
    var concat = function concat(y) {
      return y + x;
    };
    return concat;
  };
  var add_ness = addSuffix("ness");
  console.log(add_ness);
  var h = add_ness("happi");
  console.log(h);
  var add_ful = addSuffix("ful");
  var f = add_ful("fruit");
  console.log(f);
  /*
  const product =(x) => {
  ...
  */
  ...
  var _double3 = product(2);
  console.log(_double3(9));

  // private  - methods in es6
  var budget = function budget() {
    var balance = 0;
    var changeBal = function changeBal(val) {
      return balance += val;
    };

    var deposit20 = function deposit20() {
      return changeBal(20);
    };
    var withdraw20 = function withdraw20() {
      return changeBal(-20);
    };
...

{
  ...
  */
  ...
  var letterMaker = /*#__PURE__*/_regenerator2.default.mark(function letterMaker() {
    return _regenerator2.default.wrap(function letterMaker$(_context) {
      while (1) {
  ...
  var countMaker = /*#__PURE__*/_regenerator2.default.mark(function countMaker() {
    var count;
    return _regenerator2.default.wrap(function countMaker$(_context2) {
      while (1) {
  ...
  var evens = /*#__PURE__*/_regenerator2.default.mark(function evens() {
    var counteven, reset;
    return _regenerator2.default.wrap(function evens$(_context3) {
      while (1) {
...
var $export = __webpack_require__(0);
var $re = __webpack_require__(256)(/[\\^$*+?.()|[\]{}]/g, '\\$&');
...
var fround = __webpack_require__(176);
...
__webpack_require__(7) && $export($export.P + __webpack_require__(77), 'Object', {
...
var $export = __webpack_require__(0);
var setProto = __webpack_require__(127);
...
$export($export.P + $export.F * (__webpack_require__(66) != Object || !__webpack_require__(21)(arrayJoin)), 'Array', {
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(14)(proto, TO_PRIMITIVE, __webpack_require__(373));
...
var $export = __webpack_require__(0);
var $parseInt = __webpack_require__(181);
...
var $export = __webpack_require__(0);
var isInteger = __webpack_require__(178);
var abs = Math.abs;
...
$export($export.S + $export.F * !__webpack_require__(7), 'Object', { defineProperties: __webpack_require__(187) });
...
var enumKeys = __webpack_require__(453);
var isArray = __webpack_require__(86);
var anObject = __webpack_require__(1);
var isObject = __webpack_require__(4);
var toObject = __webpack_require__(9);
